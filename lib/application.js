 ...
 * The method can be used by LoopBack to find models configured in models.json
 * over the base model.
 * @param {Model} The base model class
 * @return {Model} The subclass if found or null
 */
app.getModelByType = function(modelType) {
  assert(typeof modelType === 'function', 'modelType must be a constructor');
